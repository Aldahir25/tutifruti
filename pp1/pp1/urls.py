...
from pp2.views import pedidos_view
from pp2.views import detalle_pedido
from pp2.views import confirmacion_pedido
...
urlpatterns = [
    ...
    path('carrito/actualizar/<int:producto_id>/', views.actualizar_pedido, name='actualizar_pedido'),
